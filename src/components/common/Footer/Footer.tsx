...
function Footer() {
  ...
  return (
   <footer className='footer w-screen py-10 pc:pt-[100px] pt-20 pc:mt-[200px] mt-[50px]'>
    <div className='flex gap-10 justify-center items-center'>
        {
            iconList.map((elm) => (
                    <a href={elm.url} rel="noreferrer" target='_blank' className='footer__link w-fit'>
    ...
    <div className='mx-auto w-fit pc:mt-[100px] mt-10'>
        <img id='footerFlower' className='flower pc:w-[200px] w-[100px] brightness-0 ' src='/flowers/wedding-flowers-design.svg' alt='flower'/>
    </div>
