...
function Divider({color, wave} : Props) {
  ...
  return (
   <div ref = {dividerRef} className={(wave?'bg-[#273036]' : color) + " divider w-[calc(100vw*2)] left-[50%] translate-x-[-50%] pc:h-[300px] h-[50px] absolute pc:bottom-[-200px] bottom-[-35px] z-10"}>
