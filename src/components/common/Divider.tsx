...
function Divider({color, wave} : Props) {
  ...
  return (
   <div ref = {dividerRef} className={(wave?'bg-[#273036]' : color) + " w-[calc(100vw*2)] left-[0] pc:h-[200px] h-[50px] translate-x-[-50%] absolute pc:bottom-[-100px] bottom-[25px] z-10"}>
    {wave&&<div ref={waveRef} className='absolute left-[0] bottom-[80%] w-[calc(100vw*2)] flex'>
