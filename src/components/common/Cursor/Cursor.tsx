...
<div ref={cursorRef} style={{ transform: `translate3d(${mouseX}px, ${mouseY}px, 0)`, display: outOfScreen?'none':'inline-block'}} id='cursor' className='duration-[.4s] ease-out cursor pointer-events-none w-10 h-10 mix-blend-difference rounded-full relative z-50 invert pc:inline-blockhidden pc:flex items-center justify-center hidden'>
